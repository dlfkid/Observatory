...
enum Opentelemetry_Proto_Logs_V1_SeverityNumber: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Opentelemetry_Proto_Logs_V1_SeverityNumber] = [
    .unspecified,
    .trace,
    .trace2,
    .trace3,
...
enum Opentelemetry_Proto_Logs_V1_LogRecordFlags: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Opentelemetry_Proto_Logs_V1_LogRecordFlags] = [
...
/// as well.
struct Opentelemetry_Proto_Logs_V1_LogsData: Sendable {
...
struct Opentelemetry_Proto_Logs_V1_ResourceLogs: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Opentelemetry_Proto_Logs_V1_ScopeLogs: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Opentelemetry_Proto_Logs_V1_InstrumentationLibraryLogs: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Opentelemetry_Proto_Logs_V1_LogRecord: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
