...
struct Opentelemetry_Proto_Trace_V1_TraceConfig: Sendable {
  ...
  /// The global default sampler used to make decisions on span sampling.
  enum OneOf_Sampler: Equatable, Sendable {
...
struct Opentelemetry_Proto_Trace_V1_ConstantSampler: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  enum ConstantDecision: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    static let allCases: [Opentelemetry_Proto_Trace_V1_ConstantSampler.ConstantDecision] = [
      .alwaysOff,
      .alwaysOn,
      .alwaysParent,
    ]
...
struct Opentelemetry_Proto_Trace_V1_TraceIdRatioBased: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Opentelemetry_Proto_Trace_V1_RateLimitingSampler: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Opentelemetry_Proto_Trace_V1_TraceIdRatioBased: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.samplingRatio.bitPattern != 0 {
